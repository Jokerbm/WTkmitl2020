            ...
            <div className ="feed-card highlight bb th-font2"
                ...
                <Modal show={show} onHide={handleClose}>
                    <div className="modal"  style={{display: "block"}}  role="dialog"   >
                            ...
                            <div>
                                <div className="w-clearfix content-footer animated fadeIn">
                                    <a className="" href={"#/about/" + props.name}>
                                        ...
                                        <div className="content-share-text"><span>&nbsp;&nbsp;</span><span>{props.nickname}</span></div>
                                    </a>
                        ...
                        <button id="bb_close_modalStoryDetail" onClick={handleClose} className="bb bb-close-popup animated fadeIn"></button>
                    </div>
                </Modal>
