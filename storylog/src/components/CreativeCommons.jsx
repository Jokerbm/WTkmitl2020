    ...
    return (
        <div className="home th-font2">
            ...
            <div class="w-container feed" style={{marginTop:100+'px'}}>
                <div class="tabs">
                    <a class="" href="#/philosophy"><div class="tabs-text first-no-border">PHILOSOPHY</div></a>
                    <a class=" active" href="/user-agreement"><div class="tabs-text">USER AGREEMENT</div></a>
                    <a class="" href="/creative-commons"><div class="tabs-text green">CC LICENSE</div></a><div class="tabs-line"></div>
                </div>
                <div class="w-clearfix feed-card terms">
                    <div class="feed-collection terms">
                        ...
                        <div class="feed-info-detail">
                            ...
                            <span>สัญญาอนุญาตของ Creative Commons นั้น จะขึ้นอยู่กับการเลือกชุดเงื่อนไข โดยเจ้าของผลงานสามารถเลือกได้มากกว่า 1 เงื่อนไข และแบ่งออกเป็นสัญญาอนุญาตหลักๆ ได้เป็น 6 แบบดังนี้</span></div>
                        <img class="img-terms destop" src={process.env.PUBLIC_URL + 'img/table.svg'} width="100%"></img>
                      <img class="img-terms mobile" src={process.env.PUBLIC_URL + 'img/table2.svg'} width="100%"></img>
                ...
                <div class="tabs">
                    ...
                    <a class=" active" href="/creative-commons"><div class="tabs-text green">CC LICENSE</div></a><div class="tabs-line"></div>
                </div>
            </div>
        </div>
