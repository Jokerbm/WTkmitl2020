            ...
            <div id="nav" className="nav hideNavDropdown">
                <div className="w-section bg-nav">
                    <div className="w-container nav-con">
                        ...
                        <noscript></noscript>
                        <div>
                            <div className="bb-noshadow nav-bb profile" tabIndex="-1" data-toggle="modal"
                    ...
                    <div className="modal-content">
                        ...
                        <div className="register-form center">
                            <button className="facebook-login-button mb-3">
                                ...
                                </img><span className="th-font2">DOWNLOAD</span>
                            </button>
                            <div className="text th-font2">เราใช้การล็อคJAVA APPLICATION
                            กรุณา Download
                            </div>
                        </div>
